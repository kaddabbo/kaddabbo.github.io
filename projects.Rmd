...
### Open Data: NYC Airbnb
#### April - May 2018

New York City Airbnb listings were taken from Jeff Goldsmith's [Data Science I website](http://p8105.com/dataset_airbnb.html) and used to investigate influences on price of a listings and whether borough can be predicting using the available covariates. The full report containing the findings can be found [here](https://kaddabbo.github.io/airbnb_report.pdf).

&nbsp;

### Open Data: US Twitter
